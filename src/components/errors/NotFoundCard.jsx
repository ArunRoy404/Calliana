...
export default function NotFoundCard() {
  ...
  return (
    <Reveal
      stagger
      className="relative flex w-[500px] max-w-full flex-col items-center gap-6 rounded-16 border border-solid border-border-default bg-surface-base px-8 py-12 text-center shadow-card sm:px-10"
    >
      <Reveal item>
        <CallianaLogo />
      </Reveal>

      {/* The numeral leads, from further out, so it lands as the focal point. */}
      <Reveal item distance={28}>
        <p
          aria-hidden
